...
#% key: vector
#% description: Input Vector: Vector with polygons with unique ID and the response variable (density) contained in the attribute table
#% required : yes
#%end
...
#% key: distance_to
#% type: string
#% description: Input raster: Distance to zones of interest (e.g., schools, roads, amenities)
#% required : no
#%end
#%option
#% key: tile_size
#% key_desc: value
#% type: Integer
#% description: Spatial resolution (in meters) of the Grid to produce
#% required : yes
#%end
#%option
#% key: id
#% type: string
#% description: Name of the column containing the ID of polygons (unique identifier)
#% required : yes
#%end
#%option
#% key: population
#% type: string
#% description: Name of the column containing the response variable
#% required : yes
#%end
#%option G_OPT_V_CAT
